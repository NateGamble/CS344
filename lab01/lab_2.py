...
problem = {
    ...
    "finish2": ["space on b", "b on table", "space on c", "c on table", "space on a", "a on table", "space on table"],

    "start3": ["space on a", "a on table", "space on b", "b on table", "space on c", "c on table", "space on table"],
    "finish3": ["space on a", "a on b", "b on c", "c on table", "space on table"],
    ...
    "ops": [
        {
            "action": "move b from table to c and a from table to b",
            "preconds": [
                "space on c",
                "space on b",
                "space on a",
